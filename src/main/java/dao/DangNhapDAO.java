...
public class DangNhapDAO implements DAOInterface<DangNhap>{
    ...
    public void insert(DangNhap t) {
        ...
        try {
            ...
            String sql = "INSERT INTO DANGNHAP(taiKhoan, matKhau, maNhanVien) " +
                        "VALUES(?, ? ,?)";
    ...
    public ArrayList<DangNhap> selectAll() {
        ...
        try {     
            ...
            while(rs.next()){
                ...
                DangNhap khachHang = new DangNhap(taiKhoan, matKhau, maNhanVien);
    ...
    @Override
    public DangNhap selectById(String t) {
        ...
        try {     
            ...
            while(rs.next()){
                ...
                String matKhau = rs.getString("matKhau");
                String maNhanVien = rs.getString("maNhanVien");
                ketQua = new DangNhap(taiKhoan, matKhau, maNhanVien);
            }
